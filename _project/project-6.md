...
excerpt: "<div style='display: flex; align-items: center; justify-content: space-between; font-size: 14px; background: linear-gradient(135deg, #f5f7fa, #c3cfe2); padding: 20px; border-radius: 12px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2);'>
             <div style='flex: 1; margin-left: 20px;'>
               <img src='/images/slots.gif' alt='Crystal Gem Slot Game' style='max-width: 75%; border-radius: 12px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2); transition: transform 0.3s ease;'>
             </div>
...
![Crystal Gem Slot Game Screenshot](/images/slots.gif) <!-- Add a screenshot if available -->
...
- **Interactive UI**: Click the Spin button to start the game.
...
1. **Clone the repository**:
   git clone git@github.com:SuvrangshuBarua/aquatic-slot.git
   cd aquatic-slot
