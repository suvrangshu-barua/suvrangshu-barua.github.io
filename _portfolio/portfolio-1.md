...
excerpt: "<div style='display: flex; align-items: center; justify-content: space-between; font-size: 14px;'>
             <div style='flex: 1;'>
               ...
               <ul>
                 <li style='margin: 2px 0;'>Implemented a <b>Divide and Conquer</b> based approach to optimize <b>mesh deformation</b> in real-time, resulting in a <b>performance boost from 30 fps to 60 fps on low-end devices</b></li>
